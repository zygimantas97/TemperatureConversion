...
namespace TemperatureConversion.Tests
{
    ...
    public class TemperatureConverterTests
    {
        ...
        {
            var from = TemperatureType.K;
            var to = TemperatureType.C;
        ...
        {
            var from = TemperatureType.F;
            var to = TemperatureType.K;
            ITemperatureConverter converter = new TemperatureConverter(from, to);
            var maxDiff = 0.01;
